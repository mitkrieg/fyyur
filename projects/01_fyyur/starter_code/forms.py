...
class VenueForm(Form):
    ...
    # REGEX from: https://stackoverflow.com/questions/16699007/regular-expression-to-match-standard-10-digit-phone-number/16702965
    phone = StringField(
        "phone",
    ...
    facebook_link = StringField("facebook_link", validators=[URL(), Optional()])
    website_link = StringField("website_link", validators=[URL(), Optional()])
